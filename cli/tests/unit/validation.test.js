...
import { validateVideoFile, validateOutputDir, validateNumericOption, validateApiKey, validateDurationRange, } from '../../src/validation/index.js';
    ...
    describe('validateVideoFile', () => {
        ...
        it('should reject invalid video format', async () => {
            ...
            try {
                ...
                expect(error).toBeInstanceOf(PreflightError);
                expect(error.code).toBe('INVALID_VIDEO_FORMAT');
            }
        });
    ...
    describe('validateNumericOption', () => {
        ...
        it('should reject value above maximum', () => {
            try {
                ...
                expect(error).toBeInstanceOf(PreflightError);
                expect(error.message).toContain('must be at most 100');
            }
        });
